...
// TestMPYConversion pins 1 mpy = 0.0254 mm/y and the round trip.
...
// TestMddConversion pins the g/(cm^2 y) <-> mdd factor.
...
// TestGPerM2Year checks the per-square-metre scaling.
...
// TestDensityAndAreaConversions checks the SI-side conversions.
...
// TestSummarizeDerivesEngineeringUnits checks that the summary carries
// consistent converted values.
