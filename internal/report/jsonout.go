...
// WriteChain prints the unit-chain walk for one input, one step per line.
...
// WriteResultJSON serialises a Result as JSON for script consumption.
...
// WriteErrorJSON serialises an error as {"error": "..."} on stdout.
