...
// TestWriteChain verifies the chain walk output.
...
// TestWriteResultJSON emits valid JSON carrying the derived fields.
...
// TestWriteErrorJSON emits a parseable error object.
